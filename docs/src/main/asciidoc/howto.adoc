...
In case of lack of instrumentation capabilities please file https://github.com/spring-cloud-incubator/spring-cloud-sleuth-otel/issues[an issue] with a request to add such instrumentation.
